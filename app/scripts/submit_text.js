...
var DiffSubmitter, Header, ResultText, Selectable, TO_DIFFER_API, TXT_FETCH_API;
...
Header = React.createClass({
  ...
  render: function() {
    return React.createElement("div", {
      "className": "status"
    }, React.createElement("h4", null, this.props.text), React.createElement("div", {
